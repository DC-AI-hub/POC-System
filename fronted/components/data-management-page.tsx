                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Object.entries(stats.departmentStats).map(([dept, count]) => (
                      <div key={dept} className="bg-gray-50 p-3 rounded-lg">
                        ...
                        <div className="text-lg font-semibold">{count} 人</div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="border rounded-lg p-4">
                    <div className="text-center text-gray-500 py-8">
                      <TreePine className="w-12 h-12 mx-auto mb-2 text-gray-400" />
                      <div>组织架构可视化功能开发中...</div>
                      <div className="text-sm mt-1">将支持拖拽调整层级关系</div>
                    </div>
                  </div>
                </div>
              </CardContent>
